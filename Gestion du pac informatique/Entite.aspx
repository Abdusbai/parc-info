<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Entite.aspx.cs" Inherits="Gestion_du_pac_informatique.Entite" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="d-flex align-items-center form-inline ms-auto me-0 me-md-0 my-2 my-md-3">
                    ...
                    <div class="mt-0 mb-0">
                        <asp:Button ID="NouveauBTN" class="btn btn-primary" runat="server" Text="Nouveau" OnClick="NouveauBTN_Click" />
                    </div>
                </div>
                ...
                <asp:GridView ID="GridView1" class="table table-bordered table-condensed table-responsive table-hover " runat="server" AutoGenerateColumns="False" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
                    <Columns>
                        ...
                        <asp:BoundField DataField="DirectionEn" HeaderText="Direction" />
                        <asp:BoundField DataField="DivisionEn" HeaderText="Division" />
                        <asp:BoundField DataField="ServiceEn" HeaderText="Service" />
                        <asp:BoundField DataField="AbreviationEn" HeaderText="Abréviation" />
