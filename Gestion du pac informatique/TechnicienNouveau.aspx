<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="TechnicienNouveau.aspx.cs" Inherits="Gestion_du_pac_informatique.TechnicienNouveau" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="mt-4">Technicien</h1>
    <form runat="server" method="get">
        <div class="card-body">
            <h6 class="mt-0">Ajouter un Technicien</h6>
            <hr style="width: 610px; float: left; background-color: black; height: 2px" />
            <br />
                <div class="form-floating mb-3">
                    <asp:TextBox class="form-control" ID="CinText" placeholder="CIN *" Width="611px" runat="server" MaxLength="20"></asp:TextBox>
            ...
            <div class="mt-4 mb-0">
                <asp:Button ID="AjouterBTN" class="btn btn-success" runat="server" Text="Ajouter" OnClick="AjouterBTN_Click" OnClientClick="return confirm('Voulez-vous vraiment Ajouter un Technicien')"/>
