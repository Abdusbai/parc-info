<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ServiceDeTransfert.aspx.cs" Inherits="Gestion_du_pac_informatique.ServiceDeTransfert" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" class="table table-bordered table-condensed table-responsive table-hover " runat="server" AutoGenerateColumns="False" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
                    <Columns>
                        <asp:BoundField DataField="CodeServ" HeaderText="Code du service" />
                        <asp:BoundField DataField="NomServ" HeaderText="Nom du service" />
                        <asp:BoundField DataField="DrppPerso" HeaderText="Drpp du responsable " />
