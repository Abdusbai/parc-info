<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="InterventionSd.aspx.cs" Inherits="Gestion_du_pac_informatique.InterventionTypeProb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="mt-4">Intervention par suite à donner</h1>
                    ...
                    <asp:Chart ID="Chart1" runat="server" Width="1000px" >
                        ...
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1">
                                <AxisX Title="Suite à donner"></AxisX>
                ...
                <div class="d-flex align-items-center form-inline ms-auto me-0 me-md-0 my-2 my-md-3">
                    ...
                    <div class="mt-0 mb-0">
                        <asp:DropDownList ID="SdDropDown" class="btn btn-light dropdown-toggle" runat="server" Width="250px" Height="40px" readonly="true" AutoPostBack="True" OnSelectedIndexChanged="SdDropDown_SelectedIndexChanged">
                            ...
                            <asp:ListItem Value="3">Sans</asp:ListItem>
                        </asp:DropDownList>
                    </div>
