<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Utilisateur.aspx.cs" Inherits="Gestion_du_pac_informatique.Utilisateur" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" class="table table-bordered table-condensed table-responsive table-hover " runat="server" AutoGenerateColumns="False" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
                    <Columns>
                        <asp:BoundField DataField="CinUser" HeaderText="Cin" />
                        <asp:BoundField DataField="MotDePasse" HeaderText="Mot de passe" />
                        <asp:BoundField DataField="NomUser" HeaderText="Nom" />
                        <asp:BoundField DataField="PrenomUser" HeaderText="Prénom" />
                        <asp:BoundField DataField="RoleUser" HeaderText="Rôle" /> 
                        <asp:BoundField DataField="etat_Compte" HeaderText="Statut du compte" /> 
