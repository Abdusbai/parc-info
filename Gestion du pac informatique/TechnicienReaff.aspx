<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="TechnicienReaff.aspx.cs" Inherits="Gestion_du_pac_informatique.TechnicienReaff" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 class="mt-4">Intervention par technicien réaffectée</h1>
                    ...
                    <asp:Chart ID="Chart1" runat="server" Width="1000px" >
                        ...
                        <ChartAreas>
                            <asp:ChartArea Name="ChartArea1">
                                <AxisX Title="Technicien affectée"></AxisX>
