    ...
    public partial class Categorie : System.Web.UI.Page
    {
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            try
            {
                ...
                Response.Redirect(string.Format("CategorieDetails.aspx?COCA={0}", code));
            }
            catch
            {
                connection.Close();
        ...
        {
            Response.Redirect("CategorieNouveau.aspx");
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand(string.Format("select * from Categorie where CodeCat like '%{0}%' or DescCat like '%{1}%'", TextBox1.Text, TextBox1.Text), connection);
                SqlDataReader R = cmd.ExecuteReader();
                DataTable T = new DataTable();
                T.Load(R);
                GridView1.DataSource = T;
