<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="CategorieNouveau.aspx.cs" Inherits="Gestion_du_pac_informatique.CategorieNouveau" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="mt-4">Catégorie</h1>
    <form runat="server" method="get">
        <div class="card-body">
            <h6 class="mt-0">Ajouter une Catégorie</h6>
            ...
            <div class="mt-4 mb-0">
                <asp:Button ID="AjouterBTN" class="btn btn-success" runat="server" Text="Ajouter" OnClick="AjouterBTN_Click" OnClientClick="return confirm('Voulez-vous vraiment Ajouter une Catégorie ?')"/>
