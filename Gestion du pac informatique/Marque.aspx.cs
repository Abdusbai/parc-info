    ...
    public partial class Marque : System.Web.UI.Page
    {
        ...
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            ...
            try
            {
                ...
                Response.Redirect(string.Format("MarqueDetails.aspx?COMA={0}", code));
            }
            catch
            {
                connection.Close();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand(string.Format("select * from Marque where CodeMar like '%{0}%' or DescMar like '%{1}%'", TextBox1.Text, TextBox1.Text), connection);
                SqlDataReader R = cmd.ExecuteReader();
                DataTable T = new DataTable();
                T.Load(R);
                GridView1.DataSource = T;
        ...
        {
            Response.Redirect("MarqueNouveau.aspx");
