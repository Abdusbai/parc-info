<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="TicketNouveau.aspx.cs" Inherits="Gestion_du_pac_informatique.TicketNouveau" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="mt-4">Ajouter une Ticket</h1>
        ...
        <div class="card-body">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="input-group">
                        <div class="form-floating mb-3">
                            <small>Type de problème *</small><br />
                            <asp:DropDownList ID="ProbDropDown" class="btn btn-light dropdown-toggle" runat="server" Width="300px" Height="58px" readonly="true" AutoPostBack="True" OnSelectedIndexChanged="ProbDropDown_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        ...
                        <div class="form-floating mb-3">
                            <small>Type de contacte *</small><br />
                            <asp:DropDownList ID="ContaDropDown" class="btn btn-light dropdown-toggle" runat="server" Width="300px" Height="58px" readonly="true">
                            </asp:DropDownList>
                        </div>
                    </div>

                    <div class="form-floating mb-3">
                        <asp:TextBox class="form-control" ID="DescText" placeholder="Description *" Width="611px" runat="server" MaxLength="250"></asp:TextBox>
                    ...
                    <div class="input-group">
                        <div class="form-floating mb-3">
                            <asp:DropDownList ID="MatDropDown" class="btn btn-light dropdown-toggle" runat="server" Width="300px" Height="58px" readonly="true" AutoPostBack="True" OnSelectedIndexChanged="MatDropDown_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                    ...
                    <div class="input-group">
                        <div class="form-floating mb-3">
                            <asp:DropDownList ID="LogDrowDown" class="btn btn-light dropdown-toggle" runat="server" Width="300px" Height="58px" readonly="true" AutoPostBack="True" OnSelectedIndexChanged="LogDrowDown_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
            ...
            <div class="mt-4 mb-0">
                <asp:Button ID="AjouterBTN" class="btn btn-success" runat="server" Text="Ajouter" OnClick="AjouterBTN_Click" OnClientClick="return confirm('Voulez-vous vraiment Ajouter une Ticket')" />
