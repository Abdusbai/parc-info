<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MaterielNouveau.aspx.cs" Inherits="Gestion_du_pac_informatique.MaterielNouveau" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="mt-4">Ajouter une Matériel</h1>
    <form runat="server" method="get">
        ...
        <div class="card-body">
            ...
            <div class="form-floating mb-3">
                <asp:TextBox class="form-control" ID="NumSerText" placeholder="Numéro de série *" Width="611px" runat="server" MaxLength="50"></asp:TextBox>
            ...
            <div class="mt-4 mb-0">
                <asp:Button ID="AjouterBTN" class="btn btn-success" runat="server" Text="Ajouter" OnClick="AjouterBTN_Click" OnClientClick="return confirm('Voulez-vous vraiment Ajouter une Matériel')" />
