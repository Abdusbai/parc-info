<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PersonnelNouveau.aspx.cs" Inherits="Gestion_du_pac_informatique.PersonnelNouveau" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <h1 class="mt-4">Personnel</h1>
    <form runat="server" method="get">
        <div class="card-body">
            <h6 class="mt-0">Ajouter un Personnel</h6>
            <hr style="width: 610px; float: left; background-color: black; height: 2px" />
            <br />
            <div class="input-group">
                <div class="form-floating mb-3">
                    <asp:TextBox class="form-control" ID="DrppText" placeholder="DRPP *" Width="300px" runat="server" MaxLength="10"></asp:TextBox>
                ...
                <div class="form-floating mb-3">
                    <asp:TextBox class="form-control" ID="CinText" placeholder="CIN *" Width="300px" runat="server" MaxLength="20"></asp:TextBox>
            ...
            <div class="form-floating mb-3">
                ...
                <label for="TeleBText">Poste de téléphone *</label>
            </div>
            ...
            <div class="mt-4 mb-0">
                <asp:Button ID="AjouterBTN" class="btn btn-success" runat="server" Text="Ajouter" OnClick="AjouterBTN_Click" OnClientClick="return confirm('Voulez-vous vraiment Ajouter un Personnel ?')"/>
