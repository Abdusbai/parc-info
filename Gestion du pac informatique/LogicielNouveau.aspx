<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="LogicielNouveau.aspx.cs" Inherits="Gestion_du_pac_informatique.LogicielNouveau" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="mt-4">Ajouter un Logiciel</h1>
        ...
        <div class="card-body">
            ...
            <div class="input-group">
                <div class="form-floating mb-3">
                    <asp:TextBox class="form-control" ID="NumeroText" placeholder="Numéro *" Width="300px" runat="server" MaxLength="30"></asp:TextBox>
            ...
            <div class="mt-4 mb-0">
                <asp:Button ID="AjouterBTN" class="btn btn-success" runat="server" Text="Ajouter" OnClick="AjouterBTN_Click" OnClientClick="return confirm('Voulez-vous vraiment Ajouter un Logiciel')" />
