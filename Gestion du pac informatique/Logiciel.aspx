<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Logiciel.aspx.cs" Inherits="Gestion_du_pac_informatique.Logiciel" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" class="table table-bordered table-condensed table-responsive table-hover " runat="server" AutoGenerateColumns="False" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
                    <Columns>
                        <asp:BoundField DataField="NumLogic" HeaderText="Code" />
                        <asp:BoundField DataField="NomLogic" HeaderText="Nom" />
                        <asp:BoundField DataField="NomCompag" HeaderText="Nom d'entreprise" />
                        <asp:BoundField DataField="VersionLogic" HeaderText="Version" />
