<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Materiel.aspx.cs" Inherits="Gestion_du_pac_informatique.Matériel" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="GridView1" class="table table-bordered table-condensed table-responsive table-hover " runat="server" AutoGenerateColumns="False" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
                    <Columns>
                        <asp:BoundField DataField="NumSerMat" HeaderText="Numéro du série" />
                        <asp:BoundField DataField="CodeCat" HeaderText="Catégorie" />
                        <asp:BoundField DataField="CodeMar" HeaderText="Marque" />
                        <asp:BoundField DataField="NumInvMat" HeaderText="Numéro d'inventaire" />
                        <asp:BoundField DataField="DesignMat" HeaderText="Désignation" />
                        <asp:BoundField DataField="ReferMat" HeaderText="Référence" />
                        <asp:BoundField DataField="DrppPerso" HeaderText="Drpp du personnel" />
